...
{
#if DEBUG
    [CalloutProperties("Business Burglary", "meat", "1.0")]
    public class BusinessBurglary : Callout
    {
        ...
        public BusinessBurglary()
        {
            this.InitInfo(Utils.GetLocation(CalloutPositions, Game.PlayerPed.Position));
            this.ShortName = "Silent Burglary Alarm";
            this.CalloutDescription = "911 Call : Silent alarm triggered.";
            this.ResponseCode = 2;
            this.StartDistance = 90;
        }

        public override async Task OnAccept()
        {
            this.InitBlip(75f, (BlipColor) 66, (BlipSprite) 9, 100);
            Utils.AdvNotify("commonmenu", "mp_alerttriangle", false, 1, "911 Dispatch:", "~y~Additional Info", "~w~ Silent alarm tripped. Respond with caution.");
        }
